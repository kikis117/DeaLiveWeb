...
<asp:Content ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="float-left">
        <nav>
            <ul id="menu">
                        <li><a id="M1" runat="server" href="~/Deals/RegisterDeal.aspx"  >Register A Deal</a></li>
                        <li><a id="M2" runat="server" href="~/Deals/RegisterStore.aspx">Register Your Store</a></li>
    ...
    <br />
    <br />
    <p style="color:red" > TODO: MANAGE STORE!!!!!!</p><br />
